 ...
 * @version 1.0.0
 */
final class Switch_Control extends \WP_Customize_Control
{
	/**
	...
	?>
		<div class="customizer-framework--switch-parent">
			<div class="customizer-framework--switch-container">

				<label class="customizer-framework--switch-label">
